...
public:
	...
	BaseString(BaseString<T>&& inOther)							{ mData = inOther.mData; mReservedCount = inOther.mReservedCount; mElementCount = inOther.mElementCount; inOther.mData = nullptr; inOther.mReservedCount = 0; inOther.mElementCount = 0; }
